...
Markdown supports usage of images.

To create an inline image, use a set of regular parantheses immediately
after the image text's closing square bracket, this link block `[]()` should
be prefaced with an exclamationmark. Inside the parentheses, put the URL where
